...
- Phase 3, current focus for the next six weeks: close the now-narrow public Smith uniqueness gap on top of the executable SNF kernel and new minor/diagonal-entry groundwork; the next substeps are public two-sided uniqueness, then the full PID bridge, and then the application layer
