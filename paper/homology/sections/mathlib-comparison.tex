...
At the manifest-pinned mathlib source commit
\citep{mathlib4320homology}, the definition \code{toMathlibChainComplex} sends an
...
with mathlib's nondegenerate normalized chain complex
\citep{mathlib4320normalizedChains}.  The canonical splitting of the free
module on a simplicial set then connects that complex to the normalized Moore
complex in the Karoubi envelope \citep{mathlib4320normalizedMoore}; the underlying
normalized/degenerate splitting is the classical one
\citep[Lemma 8.3.7 and Theorem 8.3.8]{weibel1994simplicial}.  Both endpoints are
