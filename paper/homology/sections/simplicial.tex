...
Version 1.2.2 includes a finite input layer whose indices enumerate only
...
degenerate faces contribute zero immediately.  This follows the normalized
chain complex, in which degenerate simplices split off
\citep[Definition 8.3.6 and Theorem 8.3.8]{weibel1994simplicial}.
The fields of
