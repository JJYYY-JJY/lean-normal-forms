...
\begin{figure}[t]
  \centering
  \input{figures/fig_uniqueness_dag}
...
The \code{Fin} theorem is
\code{isHermiteNormalFormFin_unique_of_left_equiv}; the arbitrary-index theorem
\code{isHermiteNormalFormWith_unique_of_left_equiv} requires one explicit,
fixed indexing.
