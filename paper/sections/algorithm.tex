...
The executable kernel follows the row-oriented transpose of Cohen's
column-operation HNF Algorithm 2.4.5 \citep[pp. 68--69]{cohen1993}.
\code{hermiteNormalFormFin} returns an internal
...
by iterating \code{clearFirstColumnStep}. This is the gcd-elimination part of
the transposed HNF schedule.
...
\code{IsHermiteNormalFormFin}; it implements the final canonical-remainder
reduction in the transposed row-HNF algorithm.
